...
export function PersonaModelDetailPageContent() {
      ...
      <div className="max-w-[1104px] space-y-8">
        ...
        {isReady ? (
          <>
            ...
            <section className="space-y-4">
              ...
              <Link
                href={`/app/persona/${model.id}/history`}
              ...
              <AppPanel className="space-y-4 px-6 py-6">
                ...
                <div className="flex items-center gap-3">
                  <Button asChild variant="outline">
                    <Link href={`/app/persona/${model.id}/history`}>View Job History</Link>
                  </Button>
                </div>
              </AppPanel>
            ) : (
        ...
        {channelError ? (
          <ErrorState
            ...
            action={
              <Button variant="outline" onClick={() => channel.refetch()}>
                Retry channel
              </Button>
            }
          />
