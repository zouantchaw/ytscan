...
export function PersonaModelHistoryPageContent() {
        ...
        <section className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button asChild variant="outline">
              <Link href={`/app/persona/${model.id}`}>Back to Model</Link>
            </Button>
            ...
            return (
              ...
              >
                ...
                <MetricCell
                  ...
                  accent={job.status === "failed" ? "text-destructive" : "text-foreground"}
                />
